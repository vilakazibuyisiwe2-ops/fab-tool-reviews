...
**Spring dividers with two sharp points.**

How I used them for round to round:

*   I'd set dividers on my steel ruler to 50mm (half of 100mm pipe).
*   I never looked at the number again. I'd carry that opening to my center line.
*   One point on center line, pierce a dot left, pierce a dot right. Both sides exactly 50mm.
*   For the 12 divisions on the circle — set dividers to small opening, step around the circle. No protractor guessing.
